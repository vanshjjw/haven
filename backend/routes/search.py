...
from services.book_search_api import search_books_external
...
def search_all_books():
    ...
    try:
        ...
        current_app.logger.error(f"Error searching local database: {e}")
    ...
    try:
        ...
        current_app.logger.error(f"Error searching external API: {e}")
